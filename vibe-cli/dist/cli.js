...
async function runTest() {
  console.log("\u{1F9EA} Running full test suite...");
...
program2.name("vibe").description("ViBe Project CLI").version("1.0.0");
program2.command("start").description("Start frontend and backend").action(runStart);
program2.command("help").description("help").action(runHelp);
program2.command("test").description("Run backend tests and check for failures").action(runTest);
