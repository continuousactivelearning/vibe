...
import { ArrowDown, ArrowUp, Clock, Flag, MessageSquare, Pencil, User } from 'lucide-react';
import { getEntityTypeIcon, getStatusColor } from '../constants/FlaggedConstants';
import { Badge } from '@/components/ui/badge';
import { Separator } from '@/components/ui/separator';

export default function FlaggedTableComponent({ handleSort, reports, sortBy, sortOrder, setSelectedReport, selectedReport, isUpdatingStatus, setIsUpdatingStatus, setUpdateStatusModalOpen, selectedFlagData }: any) {
                          ...
                          <Card>
                            <CardContent className="p-6">
                              ...
                              <div className="relative">
                                ...
                                <div className="space-y-6">
                                  {selectedFlagData.status.map((item: any, index: number) => (
